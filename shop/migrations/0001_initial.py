# Generated by Django 4.0.2 on 2022-02-20 22:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shop.catalog')),
            ],
            options={
                'ordering': ('name',),
